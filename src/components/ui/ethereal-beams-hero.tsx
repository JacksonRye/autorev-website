        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <span className="text-xl font-bold text-white">Autorev Labs</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-1 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 p-1 -mr-6">
              ...
              <a
                href="https://calendly.com/northbyte/free-strategy-call"
                target="_blank"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              We help companies replace repetitive work with intelligent systems that think, move, and scale faster. Autorev builds automations that do the heavy lifting — so your team can focus on what actually moves the needle. From daily tasks to entire workflows, we make operations smoother, smarter, and faster than ever.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-white mb-2 text-6xl sm:text-7xl font-black">3,000+</div>
                <div className="text-white/80 text-sm sm:text-base">hours saved</div>
              </div>
              <div className="text-center">
                <div className="text-white mb-2 text-6xl sm:text-7xl font-black">10+</div>
                <div className="text-white/80 text-sm sm:text-base">Industries automated</div>
              </div>
              <div className="text-center">
                <div className="text-white mb-2 text-6xl sm:text-7xl font-black">99.9%</div>
                <div className="text-white/80 text-sm sm:text-base">Reliability</div>
              </div>
            </div>
          </div>
        </div>
