            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-white/70">
                    AutoRev Labs builds fully-autonomous AI workflows that
                    execute, analyze, and grow — even when you're offline.
                  </p>
                </AnimatedGroup>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <a href="#contact">
                        <span className="text-nowrap">Book a Free Audit</span>
                      </a>
                    </Button>
                  </div>
                  <Button
                  ...
                  >
                    <a href="#demo">
                      <span className="text-nowrap">See Automations</span>
                    </a>
                  </Button>
                </AnimatedGroup>
              </div>
