...
const testimonials = [
  {
    ...
    text: "Autorev Labs automated our entire lead qualification process. We're now closing deals 3x faster than before."
  },
  {
    author: {
      name: "Michael Torres",
  ...
  },
  {
    ...
    text: "Autorev's automation reduced our operational costs by 60%. The system pays for itself every month."
  },
  {
    author: {
      name: "David Kumar",
...
export default function TestimonialsDemo() {
  return (
    <TestimonialsSection
      ...
      description="Join hundreds of businesses running autonomous operations with AutoRev Labs"
