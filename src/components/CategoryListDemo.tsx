  ...
  return (
    <div className="w-full min-h-screen bg-background">
      <CategoryList
        ...
        description="Autorev Labs builds systems that help businesses scale faster, close more deals, and keep revenue flowing without needing more staff. Our automations pay for themselves by unlocking speed, consistency, and predictable growth."
        categories={automationCategories}
        closingText="Every second saved is a sale gained. Autorev Labs turns your business into a self-running revenue machine."
      />
    </div>
  );
};
